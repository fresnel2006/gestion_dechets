...
//Pour la saisie du numero
      ...
      Container(child: ElevatedButton(onPressed: (){}, child: Text("SE CONNECTER",style: TextStyle(color: Colors.white),),style: ElevatedButton.styleFrom(backgroundColor: Colors.green),),),
      SizedBox(height: MediaQuery.of(context).size.height *0.02,),
      Row(
      ...
      Row(
        ...
        children: [
          ...
          TextButton(onPressed: (){}, child: Text("S'INSCRIRE",style: TextStyle(color: Colors.green),))
        ],),
    ])),
    );
  }
